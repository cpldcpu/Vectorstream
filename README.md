...
An Agentic coding experiment to create a demo for the Commodore Plus/4 8 bit home computer.
It uses an interesting codec to stream pre-rendered 3D vector graphics. You can check the 
original experiment in the supplied html file.

This demo was completely generated by Claude Fable 5, including composition of the music.
Compared to similar experiments for other platforms, the process was surprisingly tedious
and the model had to iterate many times to fix various bugs. The are interesting architectural
